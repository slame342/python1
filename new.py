...
#   операция, если логическая переменная == True

# if (логическая переменная) :
#   операция, если логическая переменная == True
# else:
#   операция, если логическая переменная == False
...
# for (переменная, которая будет содержать каждый раз разное значение из итератора) in (итератор - объект по которому
                                                                                                    # продится циклом
